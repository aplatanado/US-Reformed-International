<p align="center">
  <img src="https://austin-serves-the.yiff.church/i/qhly0d6v.png" />
</p>
...
## The Reform
![US-Reformed-International](https://austin-serves-the.yiff.church/i/qhly0d6v.png)
...
### KLC (**Recommended**, no 3rd party software required)
  Download the latest `klc.zip` from [the releases tab of this repo](https://github.com/AustinTi/US-Reformed-International/releases). Extract it and run `Setup.exe` from the folder.
